      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: "420px", margin: "0 16px" }}>
        <div className="glass-card">
          ...
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            ...
            <h1 style={{ fontSize: "2rem", fontWeight: 800, color: "white", letterSpacing: "-0.5px" }}>
              CollabSheet
            </h1>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.4)", fontSize: "12px" }}>or continue as guest</span>
            <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.15)" }} />
          </div>

          {/* Guest */}
          {!showNameInput ? (
            <button className="btn-guest" onClick={() => setShowNameInput(true)}>
              Continue as Guest
            </button>
          ) : (
            <div>
              <input
                ...
                autoFocus
              />
              <button className="btn-primary" onClick={handleGuestSignIn}
          ...
          {error && (
            <div style={{
              ...
              border: "1px solid rgba(255,100,100,0.3)", fontSize: "13px", textAlign: "center"
            }}>{error}</div>
          )}
        </div>
